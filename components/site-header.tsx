    ...
    <>
      ...
      <div className="hidden flex-col gap-4 lg:flex">
        ...
        <div className="rounded-[1.4rem] border border-ink-100 bg-white p-4">
          ...
          <div className="mt-3 rounded-[1.1rem] bg-ink-950 px-4 py-4 text-white">
            <p className="text-sm font-semibold">Start with a project, then follow the builder behind it.</p>
        ...
        <div className="rounded-[1.4rem] border border-ink-100 bg-white p-4">
          ...
          <Link
            className="mt-4 flex w-full items-center justify-center rounded-[1rem] bg-ink-900 px-4 py-3 text-sm font-semibold text-white transition hover:bg-ink-800"
            href={sessionUser ? "/api/auth/logout" : "/auth/login"}
          >
            {sessionUser ? dictionary.nav.logout : dictionary.nav.login}
          </Link>
